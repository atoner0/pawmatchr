    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[{
                "role": "user",
                "content": (
                    "Rewrite the following compatibility notes as clear, natural, conversational prose, 3-4 sentences. Use UK spelling and terminology (e.g. garden not yard). Avoid sales-style adjectives. Do not add any facts not listed below. Do not invent numbers. Do not generalise or rephrase a specific statement into a broader claim, keep notes framed around an adopter's home or space that way rather than a general statement.\n\n"f"{top_bullets}"
                ),
            }],
        )
