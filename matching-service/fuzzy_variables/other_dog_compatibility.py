...
def other_dog_compatibility(adopter: Adopter, dog: Dog) -> tuple[float, str | None, str]:
    """
    Scalar wrapper around other_dog_compatibility_batch, scoring a single adopter/dog pair. 
