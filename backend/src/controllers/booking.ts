...
export const getUpcomingBooking = async ( req: AdopterAuthRequest, res: Response): Promise<void> => {
    try {
        const adopter = req.user!
        const booking = await getNextUpcomingBookingAdopter(adopter.adopter_id)
